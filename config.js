...
configData.general = {
  apiVersion: "0.0.1",
  serverName: "Coma API",
  id: "coma1bierbitte",                                    // id can be set here, or it will be generated dynamically.  Be sure that every server you run has a unique ID (which will happen when genrated dynamically)
  serverToken: "1bierbitte",                                       // A unique token to your application that servers will use to authenticate to each other
  welcomeMessage : "This is a API for coma. :D",        // The welcome message seen by TCP and webSocket clients upon connection
